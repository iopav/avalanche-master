...
if __name__ == "__main__":
    run_manual_entry(dataset="uwave", method="fecam", parameters=PARAMETERS, order_id=ORDER_ID, seed=SEED, epochs=EPOCHS, device=DEVICE, data_mode=DATA_MODE, backbone_id=BACKBONE_ID)
