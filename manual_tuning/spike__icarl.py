...
ORDER_ID, SEED, EPOCHS, DEVICE = 1, 62, 50, "cuda" #50

if __name__ == "__main__":
    run_manual_entry(dataset="spike", method="icarl", parameters=PARAMETERS, order_id=ORDER_ID, seed=SEED, epochs=EPOCHS, device=DEVICE, data_mode=DATA_MODE, backbone_id=BACKBONE_ID)
