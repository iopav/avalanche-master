...
PARAMETERS = {
    "optimizer": "SGD",
    # Adam 学习率。增大可加快适应，但可能破坏旧类；减小可缩小参数更新，
    # 但可能使新类欠拟合。
    "learning_rate": 0.05,
    "momentum": 0.9,
    "weight_decay": 0.0,
...
if __name__ == "__main__":
    run_manual_entry(dataset="spike", method="er_ace", parameters=PARAMETERS, order_id=ORDER_ID, seed=SEED, epochs=EPOCHS, device=DEVICE, data_mode=DATA_MODE, backbone_id=BACKBONE_ID)
