...
PARAMETERS = {
    "optimizer": "Adam",
    # Adam 学习率。增大可加快当前任务学习，但会扩大参数移动并增加旧知识漂移；
...
if __name__ == "__main__":
    run_manual_entry(dataset="texture", method="si", parameters=PARAMETERS, order_id=ORDER_ID, seed=SEED, epochs=EPOCHS, device=DEVICE, data_mode=DATA_MODE, backbone_id=BACKBONE_ID)
